...
## 5. Сделайть тап-области маленькими и милыми
...
## 6. Делайть отзывчивым, но только для некоторых разрешений
...
"[исчерпывающее руководство по стратегие загрузки шрифтов][46].”
...
Являются ли тап-цели достаточно большыми? Есть сложные элементы интерфейса, такие как карусели правильно реализованы ли они на мобильном телефоне? Интерактивны ли номера телефонов? Контент доступен для выделения? Вы делаете навигацию видимой везде, где это возможно?
...
в другой сад.
 ...
 [Найк и БестБай]: img/image_2-500-opt.png "Альтернатирвный текст"
